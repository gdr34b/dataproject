...
Just testing citations. Starting with the two older papers, the first, scattered \cite{franke1982scattered}. Second, smooth \cite{franke1982smooth}. Then the newer paper, multistep \cite{floater1996multistep}.
Then the two potential examples, the Australian example \cite{jeffrey2001using}. And the MODIS example \cite{zhao2005improvements}.
